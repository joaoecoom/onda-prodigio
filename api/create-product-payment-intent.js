...
module.exports = async function handler(req, res) {
    ...
    var amount = productCheckoutConfig.getAmountCentsForMode(productId, mode);
    ...
    try {
        var paymentIntent = await stripeClient.stripe.paymentIntents.create({
            ...
            description: product.name + ' — Onda Prodígio',
        ...
        console.error('Erro ao criar PaymentIntent do produto:', error);
