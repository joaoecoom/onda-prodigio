(function () {
    ...
    var SVG_ATTR = ' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"';
    ...
    var PATHS = {
        ...
        radar: '<path d="M19.07 4.93A10 10 0 0 0 6.99 3.34"/><path d="M4 6h.01"/><path d="M2.29 9.62A10 10 0 1 0 21.31 8.35"/><path d="M12 12v10"/><path d="m16 16-4-4"/>',
        messageCircle: '<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/>',
        zap: '<path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13.5 11H20a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 10.5 13H4Z"/>',
    ...
    function svg(name) {
        ...
        return '<span class="dr-icon" aria-hidden="true"><svg' + SVG_ATTR + '>' + inner + '</svg></span>';
    }

    function moduleIcon(moduleId) {
        return svg(MODULE_MAP[moduleId] || 'circle');
    }
