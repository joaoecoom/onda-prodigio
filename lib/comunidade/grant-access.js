...
var sendPurchaseCompanionEmail = require('./send-purchase-companion-email');
...
async function grantAccessFromPaymentIntent(paymentIntent) {
    ...
    var companionEmailResult = await sendPurchaseCompanionEmail.maybeSendAfterGrant({
        admin: admin,
        member: member,
        email: email,
        fullName: fullName,
        ...
        referenceId: paymentIntent.id,
        provisionalPassword: provisional.password,
        nextProductOffer: emailResult.next_product_offer || whatsappResult.next_product_offer || null,
    });
    ...
    return {
        ...
        companion_email_result: companionEmailResult,
