...
function buildReport(paymentIntents, options) {
    ...
    return {
        ...
        note: 'Apenas vendas do produto Onda Prodígio (checkout9 e checkout19), sem upsells pós-compra, comunidade nem outros produtos. Receita = total cobrado no Stripe (produto + order bumps do checkout). «Tráfego» = UTMs Meta ou funil pago.',
