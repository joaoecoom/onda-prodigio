...
function buildReport(paymentIntents) {
    ...
    return {
        ...
        note: 'Dados reais do Stripe (funil, comunidade e upsells). Campanha/conjunto/anúncio vêm dos UTMs Meta quando existem. «Resultados tráfego» = funil + upsells + vendas com UTMs Meta.',
    };
}
