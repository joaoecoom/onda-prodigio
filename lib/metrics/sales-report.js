...
function buildReport(paymentIntents) {
    ...
    return {
        ...
        note: 'Dados reais do Stripe. Campanha/conjunto/anúncio vêm dos UTMs Meta (utm_campaign, utm_term, utm_content). Vendas antigas podem aparecer como Desconhecido.',
    };
}
