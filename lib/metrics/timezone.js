...
function resolveMetaDateRange(from, to, accountTimezone) {
    ...
    var endUnix = getDayEndUnix(toDate, reportingTimezone);
    var metaSince = formatIsoDateInTimezone(startUnix, accountTz);
    var metaUntil = formatIsoDateInTimezone(endUnix, accountTz);

    return {
        since: metaSince,
        until: metaUntil,
        adjusted: true,
        alignment: 'reporting_window_hourly',
        use_hourly_filter: true,
