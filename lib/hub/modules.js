...
var HUB_MODULES = [
    ...
    },
    {
        id: 'checkout',
        label: 'Checkout',
        description: 'Layout, preço, order bumps e pagamento Stripe — construir com Gemini.',
...
function getModulesForOffer(offer) {
    ...
    return HUB_MODULES.map(function (module) {
        ...
        if (module.id === 'checkout') {
            href = '/checkout-builder?offer=' + slug;
            external = false;
            status = (offer.checkouts || []).length ? 'live' : 'soon';
        }
