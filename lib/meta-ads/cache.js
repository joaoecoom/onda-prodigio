...
function getReportCacheKey(accountId, from, to) {
    return cache.getCacheKey(['meta-report-v3', accountId, from, to]);
}
...
function getSummaryCacheKey(accountId, from, to) {
    return cache.getCacheKey(['meta-summary-v3', accountId, from, to]);
}
...
function clearAccountReports(accountId) {
    cache.clearMatching('meta-report-v3::' + accountId + '::');
    cache.clearMatching('meta-summary-v3::' + accountId + '::');
}
