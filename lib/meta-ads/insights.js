...
async function getInsightsByLevel(accountId, from, to, level, accountCurrency, filterOptions) {
    var reportingFrom = filterOptions && filterOptions.reportingFrom ? filterOptions.reportingFrom : from;
    var reportingTo = filterOptions && filterOptions.reportingTo ? filterOptions.reportingTo : to;
